"""
Entry point for GUI, can be launched directly from command line
"""
...
import comms as c
import orbits as o
import payloads as pt
import thermal as tt
import adcs as at
import gnc as gt
import cdh as cdh
...
def main():
    ...
    def outPutData():
        with open('data_models/parameters.csv', mode='w') as parameters:
